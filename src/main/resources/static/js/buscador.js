var botonTiendaFav, botonProdFav, botonCarrito;
      ...
      botonTiendaFav.addEventListener("click", function(){
        ...
        var url = "http://localhost:8080/revisarCompradores/compradores/"+idUsuario+"/agregarTienda/"+idTienda;
      ...
      botonProdFav.addEventListener("click", function(){
        var xhr = new XMLHttpRequest();
        var url = "http://localhost:8080/revisarCompradores/compradores/"+idUsuario+"/agregarProducto/"+idProducto;
        xhr.open('PUT', url, true);
        xhr.send();
      });
      ...
      botonCarrito.addEventListener("click", function(){
        var xhr = new XMLHttpRequest();
        var url = "http://localhost:8080/revisarCompradores/compradores/"+idUsuario+"/agregarCarrito/"+idProducto;
        xhr.open('PUT', url, true);
        xhr.send();
      });